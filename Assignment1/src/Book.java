...
public class Book extends Media {
	...
	// Return a new object if the genre is correct, or throw an
	// IllegalArgumentException with the message "Genre is invalid"
	public static Book of(String title, String author, int year, int rating, int noPages, Genre genre) {
		
		Book book = new Book(title, author, year, rating, noPages, genre);

		if (!(genre.equals(new Fantasy()) || genre.equals(new Autobiography()))) {
